...
${formData.message}`;
        ...
        window.open(`https://wa.me/94772202885?text=${encodedText}`, '_blank');
    };
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-12">
                            ...
                            <div className="flex flex-col gap-3 md:col-span-2 group">
                                <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#b38e5d]">Subject</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div className="md:col-span-2 pt-8">
                                <button type="submit" className="inline-flex items-center justify-center px-16 py-5 bg-[#0B0F19] text-white font-bold text-xs tracking-[0.3em] uppercase hover:bg-[#b38e5d] transition-all duration-500 shadow-xl shadow-black/10 active:scale-[0.98]">
                                    Submit Inquiry
                                </button>
                                ...
                                <div className="mt-8 flex items-center gap-4">
                                    ...
                                    <a href="https://wa.me/94772202885" className="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-full text-gray-500 hover:text-[#b38e5d] hover:border-[#b38e5d] transition-all duration-300">
                                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
